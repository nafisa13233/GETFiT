...
using RegisterViewModel = GETFiT.Areas.Admin.Models.RegisterViewModel;
    ...
    public class AdminAccountController : Controller
    {
        ...
        public async Task<ActionResult> AdminRegister(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string filePathString = "/Images/Trainer_Pictures/" + fileName;
                fileName = Path.Combine(Server.MapPath("~/Images/Trainer_Pictures/"), fileName);
        ...
        {
            var model = new TrainerRegisterViewModel();
            return View(model);
        }
        ...
        public async Task<ActionResult> TrainerRegister(TrainerRegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    PhoneNumber = model.PhoneNumber,
                    Gender = model.Gender,
                    trainer = new GETFiT.Models.Trainer
                    {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("TrainerRegister", "AdminAccount", new { area = "Admin" });
                }
                AddErrors(result);
            }
